        ...
        <div className="page-margins flex h-16 items-center justify-between w-full">
          <div className="flex gap-10 items-center">
            <Link href="/" className="flex items-center font-display text-2xl text-white">
              ...
              ></Image>
              <p className="subpixel-antialiased  ml-2 font-sans font-thin tracking-widest">Fagfilm</p>
            </Link>
            <div className="mt-2 subpixel-antialiased text-base text-white font-thin flex gap-6">
